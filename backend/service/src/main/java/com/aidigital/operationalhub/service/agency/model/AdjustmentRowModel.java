 ...
 * of them can never actually be persisted. The campaign identity and the created/last-modified stamps
 * are set by the service from the resolved campaign and current user, never by the caller.
 *
...
public record AdjustmentRowModel(
		...
		String agencyId, String industryCode, String channel, String tactic,
