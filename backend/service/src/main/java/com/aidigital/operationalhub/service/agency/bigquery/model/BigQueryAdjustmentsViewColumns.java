...
public final class BigQueryAdjustmentsViewColumns {
	...
	/**
	 * BigQuery column holding the naming-convention campaign name. It is display/write identity from the
	 * mart itself; Hub scoping is bridged through NetSuite line item ids and {@link #CONSTRUCTED_NAME},
	 * not by matching this value to a Hub campaign name.
	 */
