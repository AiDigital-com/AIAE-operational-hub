...
This file provides reusable engineering guidance to Codex. Apply it to
...
- `.Codex/` — self-contained Codex rules, docs, skills, and task artifacts for this repository

## Start Here

1. Read `.Codex/agent_docs/index.md`.
...
3. For frontend work, read the relevant docs before changing code:
   ...
   - `frontend_style.md`
   - `frontend_testing.md`
4. Respect `.Codex/rules/*.md`.
5. Read `.Codex/agent_docs/skill-selection.md` before choosing between GSD,
...
- Backend tests follow the project style from `.Codex/rules/20-tests.md`.
...
- Frontend tests follow the project style from `.Codex/rules/50-frontend-tests.md`.
