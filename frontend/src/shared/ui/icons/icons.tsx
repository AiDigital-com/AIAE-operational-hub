...
/** Six-dot drag grip, marking a column header the pointer can pick up and move. */
...
export function LogoIcon({ className, fill = "var(--primary)", stroke = "#ffffff" }: LogoIconProps) {
  return (
